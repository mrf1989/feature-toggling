...
export default class FeatureRetrieverSingleton implements PricingInterface {
  private static instance: FeatureRetrieverSingleton | null = null;
  private user: Person;
  ...
  public static getInstance(): FeatureRetrieverSingleton {
    if (!FeatureRetrieverSingleton.instance) {
      FeatureRetrieverSingleton.instance = new FeatureRetrieverSingleton(unauthenticatedUser, defaultFreePlan);
    }
    return FeatureRetrieverSingleton.instance;
  }

  public destroyInstance(): void {
    const instance = FeatureRetrieverSingleton.instance;
    if (!instance) {
      return;
    }
